...
const Workspace = require('./api/models/Workspace');
...
class WorkspaceImpl extends Workspace {
    constructor(params, eventBroadcaster) {
        super(params);
        // TODO : hide root path from client
        ...
        Object.defineProperties(this, {
            ...
            disposable: {
                writable: true, // someday, we can promote disposable workspace to regular one. 
                value: !!params.disposable
            },
            clients: {          // usually, workspace session
                writable: false, 
                value : {} 
            },
            watcher : {
