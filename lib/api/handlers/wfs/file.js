...
function readFile(req, res, next) {
    ...
    try {
        let {ws} = req.getHelper('resolve-paths')(req);

        // we don't have to normalize wfsPath, for sanitizer has done already.
        ...
        return serveStatic(req, res, next); // must not proceed with 'next' here
